  ...
  return (
    <main className='p-3 max-w-4xl mx-auto'>
        <h1 className='text-3xl font-semibold text-center my-7'> 
            Ажурирање на информации за недвижноста
        </h1>      
        <form onSubmit={handleSubmit} className='flex flex-col sm:flex-row gap-4'>
            <div className='flex flex-col gap-4 flex-1'>
                <input type='text' placeholder='Наслов' className='border p-3 rounded-lg' 
                id='name' maxLength='62' minLength='6' required onChange={handleChange} value={formData.name}/>
                ...
                <div className='flex flex=wrap gap-6'>
                    ...
                    <div className='flex items-center gap-2'>
                        <input type='number' id='regularPrice' min='500' max='30000' required 
                    ...
                    {formData.offer && (
                         <div className='flex items-center gap-2'>
                         <input type='number' id='discountPrice' min='0' max='30000' required 
            ...
            <div className='flex flex-col flex-1 gap-4'>
                ...
                <button disabled={loading || uploading} className='p-3 bg-slate-700 text-white rounded-lg hover:opacity-95 disabled:opacity-80'>
                    {loading ? 'Се ажурира недвижноста...' : 'Ажурирајте ја недвижноста'}
                </button>
