  ...
  return (
    <div className="p-3 max-w-lg mx-auto"> 
      ...
      <form className="flex flex-col gap-4">
        ...
        p-3 hover:opacity-95 disabled:opacity-80">Ажурирај</button>       
      </form>
      <div className="flex justify-between mt-5">
        <span className="text-red-700 cursor-pointer">Избришете го корисничкиот профил</span>
        <span className="text-red-700 cursor-pointer">Одјавете се</span>
      </div>
